...
unique(demographic_data$County.per.CenTrac)
demographic_data <- demographic_data[ ,!names(demographic_data) %in% c("Trade.Name","County","Inspection.Grade","Inspection.Date","Owner.Name","City","State.Code","Zip.Code","Deficency.Number","Deficency.Description")]
